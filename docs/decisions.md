...
- status: decided
- date: 2026-07-10
- verdict: product-forge runs on the substrate-kit agent workflow.
- why: A repo-resident working agreement, decision ledger, and session
  ...
  kit starts product-forge governed instead of accreting rules ad hoc.
