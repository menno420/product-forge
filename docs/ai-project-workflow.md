# product-forge — AI project workflow
...
5. **Verify** — run `python3 bootstrap.py check --strict (repo gate) + each touched product's own test command per its README` before shipping.
