# product-forge — runtime contracts
...
Every change lands via a PR merged on green (kit ceremony, born-red card, READY never draft, land-your-own per R21). Money/external-account steps are NEVER executed — they become conservative six-field owner plans (Q-0259 r.4). Releases via the proven workflow_dispatch recipe.
